...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 13:44:33 2021
    ...
    for x in range(0,401):
        for y in range(0,301):
            ...
            if y-0.7*x>=74.28 and y-0.7*x <= 98.76 and y+1.425*x>=176.42 and y+1.428*x<=438.045:
                ...
                oblist1.append([x,y])
            '''
            if y-0.7*x>=(79.28-d) and y-0.7*x <= (98.76+d) and y+1.425*x>=(176.42-d) and y+1.428*x<=(438.045+d):
                riglist.add(str([x,y]))
            '''    
            ...
            '''
            if y>=(x-44.316)*math.tanh(35)+87.109 and y <= (x-15.6376)*math.tanh(35)+128.066 and y>=-math.tanh(55)*(x-15.637)+128.066 and y<=-math.tanh(55)*(x-163.084)+281.36:
                riglist.add(str([x,y]))
            '''
            #Circle Object
...
s=[16,16]                   #Start Position Test Case2
g=[381,281]                 #Goal Position Test Case2   
...
if str(s) in riglist or str(g) in riglist: #checking if the goal or start node is in the obstacspace
    ...
    while not q.empty():  #Process when queue is not empty
        ...
        if (str(l_child) not in riglist) and (l_child[0]>0 and l_child[0]<xmax) and (l_child[1]>0 and l_child[1]<ymax):
            if (str(l_child) not in visited_nodes):
                #img[l_child[0],ymax-l_child[1]]=225
        ...
        if (str(r_child) not in riglist) and (r_child[0]>0 and r_child[0]<xmax) and (r_child[1]>0 and r_child[1]<ymax):
            if (str(r_child) not in visited_nodes):
                #img[r_child[0],ymax-r_child[0]]=225
        ...
        if (str(u_child) not in riglist) and (u_child[0]>0 and u_child[0]<xmax) and (u_child[1]>0 and u_child[1]<ymax):
            if (str(u_child) not in visited_nodes):
                #img[xmax-u_child[1],(u_child[0])]=225
        ...
        if (str(d_child) not in riglist) and (d_child[0]>0 and d_child[0]<xmax) and (d_child[1]>0 and d_child[1]<ymax):
            if (str(d_child) not in visited_nodes):
                #img[xmax-d_child[1],(d_child[0])]=225
        ...
        if (str(ul_child) not in riglist) and (ul_child[0]>0 and ul_child[0]<xmax) and (ul_child[1]>0 and ul_child[1]<ymax):
            if (str(ul_child) not in visited_nodes):
                #img[xmax-ul_child[1],(ul_child[0])]=225
        ...
        if (str(dl_child) not in riglist) and (dl_child[0]>0 and dl_child[0]<xmax) and (dl_child[1]>0 and dl_child[1]<ymax):
            if (str(dl_child) not in visited_nodes):
                #img[xmax-dl_child[1],(dl_child[0])]=225
        ...
        if (str(ur_child) not in riglist) and (ur_child[0]>0 and ur_child[0]<xmax) and (ur_child[1]>0 and ur_child[1]<ymax):
            if (str(ur_child) not in visited_nodes):
                #img[xmax-ur_child[1],(ur_child[0])]=225
        ...
        if (str(dr_child) not in riglist) and (dr_child[0]>0 and dr_child[0]<xmax) and (dr_child[1]>0 and dr_child[1]<ymax):
            if (str(dr_child) not in visited_nodes):
                #img[xmax-dr_child[1],(dr_child[0])]=225
